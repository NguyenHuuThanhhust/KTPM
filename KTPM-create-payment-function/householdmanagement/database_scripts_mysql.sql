...
ALTER TABLE LOAIPHI
ADD COLUMN MUCTIEU DECIMAL(15,2) DEFAULT 0.00 COMMENT 'Tổng số tiền mục tiêu cần đóng góp'
AFTER DINHMUC;
...
CREATE TABLE THUPHI (
    ...
    NGAYDONG DATETIME,
    GHICHU TEXT,
    CONSTRAINT FK_THUPHI_HOKHAU FOREIGN KEY (SOHOKHAU) REFERENCES HOKHAU(SOHOKHAU),
    CONSTRAINT FK_THUPHI_DOTTHU FOREIGN KEY (MADOTTHU) REFERENCES DOTTHU(MADOTTHU),
    CONSTRAINT FK_THUPHI_LOAIPHI FOREIGN KEY (MALOAI) REFERENCES LOAIPHI(MALOAI)
) ENGINE=InnoDB;
